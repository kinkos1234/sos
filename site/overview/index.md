...
```mermaid
graph LR
    T1["Tier -1<br/>순수기초<br/>10개 개념"] --> T0["Tier 0<br/>응용기초<br/>10개 개념"]
    T0 --> T1C["Tier 1<br/>핵심<br/>5개 개념"]
    T1C --> T2["Tier 2<br/>프레임워크<br/>5개 개념"]
    T2 --> T3["Tier 3<br/>구현<br/>5개 개념"]
...
graph TB
    ...
    subgraph PLTR["팔란티어"]
        ONT[온톨로지] --> PLTR_CORE((팔란티어))
        APO[Apollo<br/>자율배포] --> PLTR_CORE
        AIP_CORE --> PLTR_CORE
    end
