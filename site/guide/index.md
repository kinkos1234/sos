...
> 원본 자료: [@heretics_gene](https://www.threads.com/@heretics_gene)
> 자료 편집: [@specal1849](https://www.threads.com/@specal1849)
> 사이트 기획: [@comad.j](https://www.threads.com/@comad.j)
>
...
- 본 자료의 [개요 (Executive Summary)](/overview/) 전체
...
> 참조: [Tier 1: 핵심](/core/), [Tier 2: 프레임워크](/framework/)
...
> 참조: [Tier 2: 프레임워크 — C07 ReBAC](/framework/)
...
> 참조: [Tier 2: 프레임워크 — C06 분석공간](/framework/)
...
체크박스를 클릭하여 학습 진도를 기록하세요. 브라우저에 자동 저장됩니다.

<script setup>
import ProgressTracker from '../.vitepress/theme/components/ProgressTracker.vue'
</script>
